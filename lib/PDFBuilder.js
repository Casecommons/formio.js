...
var PDFBuilder = /*#__PURE__*/function (_WebformBuilder) {
  ...
  var _proto = PDFBuilder.prototype;
  ...
  _proto.afterAttach = function afterAttach() {
    var _this4 = this;
  ...
  _proto.setUploadError = function setUploadError(message) {
  ...
  _proto.getParentContainer = function getParentContainer(component) {
    var container = [];
  ...
  _proto.initIframeEvents = function initIframeEvents() {
    var _this7 = this;
  ...
  _proto.initDropzoneEvents = function initDropzoneEvents() {
  ...
  _proto.prepSidebarComponentsForDrag = function prepSidebarComponentsForDrag() {
    var _this8 = this;
  ...
  _proto.updateDropzoneDimensions = function updateDropzoneDimensions() {
    if (!this.refs.iframeDropzone) {
      return;
    }
  ...
  _proto.onDropzoneDrop = function onDropzoneDrop(e) {
    this.dropEvent = e;
    e.preventDefault();
    return false;
  };
