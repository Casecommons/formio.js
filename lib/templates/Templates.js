...
var Templates = /*#__PURE__*/function () {
  ...
  Templates.addTemplate = function addTemplate(name, template) {
    Templates.templates[name] = template;
  };

  Templates.extendTemplate = function extendTemplate(name, template) {
    Templates.templates[name] = _lodash["default"].merge({}, Templates.templates[name], template);
  };

  Templates.setTemplate = function setTemplate(name, template) {
