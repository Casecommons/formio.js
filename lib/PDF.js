...
var PDF = /*#__PURE__*/function (_Webform) {
  ...
  _proto.getSubmission = function getSubmission() {
    var _this4 = this;
  ...
  _proto.showErrors = function showErrors(error, triggerEvent) {
  ...
  _proto.isSubmitButtonHidden = function isSubmitButtonHidden() {
    var hidden = false;
