...
var WebformBuilder = /*#__PURE__*/function (_Component) {
  ...
  var _proto = WebformBuilder.prototype;

  _proto.allowDrop = function allowDrop() {
    return true;
  };

  _proto.addExistingResourceFields = function addExistingResourceFields(resources) {
    var _this2 = this;
  ...
  _proto.attachTooltip = function attachTooltip(component, title) {
  ...
  _proto.attachComponent = function attachComponent(element, component) {
    var _this3 = this;
  ...
  _proto.createForm = function createForm(options) {
   ...
   * @param component
   */
  _proto.findNamespaceRoot = function findNamespaceRoot(component) {
  ...
  _proto.recurseNamespace = function recurseNamespace(component) {
  ...
  _proto.searchFields = function searchFields() {
    var _this6 = this;
  ...
  _proto.orderComponents = function orderComponents(groupInfo, foundComponents) {
  ...
  _proto.updateDragAndDrop = function updateDragAndDrop() {
  ...
  _proto.initDragula = function initDragula() {
    var _this7 = this;
  ...
  _proto.getComponentInfo = function getComponentInfo(key, group) {
  ...
  _proto.getComponentsPath = function getComponentsPath(component, parent) {
  ...
  _proto.onDrop = function onDrop(element, target, source, sibling) {
  ...
  _proto.setForm = function setForm(form) {
    var _this9 = this;
  ...
  _proto.populateRecaptchaSettings = function populateRecaptchaSettings(form) {
  ...
  _proto.removeComponent = function removeComponent(component, parent, original) {
    var _this10 = this;
  ...
  _proto.replaceDoubleQuotes = function replaceDoubleQuotes(data) {
  ...
  _proto.updateComponent = function updateComponent(component, changed) {
    var _this11 = this;
  ...
  _proto.findRepeatablePaths = function findRepeatablePaths() {
    var repeatablePaths = [];
    var keys = new Map();
  ...
  _proto.highlightInvalidComponents = function highlightInvalidComponents() {
  ...
  _proto.saveComponent = function saveComponent(component, parent, isNew, original) {
    var _this12 = this;
  ...
  _proto.emitSaveComponentEvent = function emitSaveComponentEvent(schema, originalComp, parentComponentSchema, path, index, isNew, originalComponentSchema) {
    this.emit('saveComponent', schema, originalComp, parentComponentSchema, path, index, isNew, originalComponentSchema);
  };

  _proto.editComponent = function editComponent(component, parent, isNew, isJsonEdit, original) {
    var _this13 = this;
  ...
  _proto.updateComponentKey = function updateComponentKey(data) {
  ...
  _proto.copyComponent = function copyComponent(component) {
  ...
  _proto.pasteComponent = function pasteComponent(component) {
    if (!window.sessionStorage) {
      return console.warn('Session storage is not supported in this browser.');
    }
  ...
  _proto.isParentSaveChildMethod = function isParentSaveChildMethod(parentComp) {
    return !!(parentComp && parentComp.saveChildComponent);
  };

  _proto.getParentElement = function getParentElement(element) {
  ...
  _proto.addBuilderComponentInfo = function addBuilderComponentInfo(component) {
  ...
  _proto.destroy = function destroy(deleteFromGlobal) {
    if (this.webform.initialized) {
  ...
  _proto.addBuilderGroup = function addBuilderGroup(name, group) {
    if (!this.groups[name]) {
  ...
  _proto.updateBuilderGroup = function updateBuilderGroup(name, group) {
    if (this.groups[name]) {
      this.groups[name] = group;
      this.triggerRedraw();
    }
  ...
  _proto.generateKey = function generateKey(info) {
