...
var WebformBuilder = /*#__PURE__*/function (_Component) {
  ...
  function WebformBuilder() {
    ...
    _this.sideBarScrollOffset = _lodash["default"].get(_this.options, 'sideBarScrollOffset', 0); // Setup the builder options.
  ...
  _createClass(WebformBuilder, [{
    ...
    value: function setForm(form) {
      ...
      var keyboardActionsEnabled = _lodash["default"].get(this.options, 'keyboardBuilder', false) || ((_this$options$propert = this.options.properties) === null || _this$options$propert === void 0 ? void 0 : _this$options$propert.keyboardBuilder);
    ...
    value: function updateComponent(component, changed) {
      ...
      if (defaultValueComponent && component.type !== 'hidden') {
        ...
        if (!defaultChanged) {
          _lodash["default"].assign(defaultValueComponent.component, _lodash["default"].omit(_objectSpread({}, component), ['key', 'label', 'placeholder', 'tooltip', 'hidden', 'autofocus', 'validate', 'disabled', 'defaultValue', 'customDefaultValue', 'calculateValue', 'conditional', 'customConditional', 'id', 'fields.day.required', 'fields.month.required', 'fields.year.required']));

          var parentComponent = defaultValueComponent.parent;
          var tabIndex = -1;
          var index = -1;

          if (parentComponent && parentComponent.tabs) {
    ...
    value: function attachEditComponentControls(component, parent, isNew, original, ComponentClass) {
      ...
      var cancelButtons = this.componentEdit.querySelectorAll("[".concat(this._referenceAttributeName, "=\"cancelButton\"]"));
      ...
      var removeButtons = this.componentEdit.querySelectorAll("[".concat(this._referenceAttributeName, "=\"removeButton\"]"));
      ...
      var saveButtons = this.componentEdit.querySelectorAll("[".concat(this._referenceAttributeName, "=\"saveButton\"]"));
      saveButtons.forEach(function (saveButton) {
        _this13.editForm.addEventListener(saveButton, 'click', function (event) {
          event.preventDefault();

          var errors = _this13.editForm.validate(_this13.editForm.data, {
            dirty: true
          });
          ...
          if (errors.length) {
            ...
            _this13.editForm.showErrors(errors);
      ...
      var previewButtons = this.componentEdit.querySelectorAll("[".concat(this._referenceAttributeName, "=\"previewButton\"]"));
      previewButtons.forEach(function (previewButton) {
        _this13.editForm.addEventListener(previewButton, 'click', function (event) {
          var _this13$editForm$subm;
          ...
          _this13.editForm.attach(_this13.componentEdit.querySelector("[".concat(_this13._referenceAttributeName, "=\"editForm\"]")));

          _this13.updateComponent((_this13$editForm$subm = _this13.editForm.submission.data) !== null && _this13$editForm$subm !== void 0 ? _this13$editForm$subm : component);
    ...
    value: function editComponent(component, parent, isNew, isJsonEdit, original) {
      ...
      cancelButtons.forEach(function (cancelButton) {
        _this14.addEventListener(cancelButton, 'click', function (event) {
          event.preventDefault();

          _this14.editForm.detach();

          _this14.emit('cancelComponent', component);

          _this14.dialog.close();
      ...
      removeButtons.forEach(function (removeButton) {
        _this14.addEventListener(removeButton, 'click', function (event) {
          event.preventDefault(); // Since we are already removing the component, don't trigger another remove.
      ...
      saveButtons.forEach(function (saveButton) {
        _this14.addEventListener(saveButton, 'click', function (event) {
          event.preventDefault();

          if (!_this14.editForm.checkValidity(_this14.editForm.data, true, _this14.editForm.data)) {
            _this14.editForm.setPristine(false);

            _this14.editForm.showErrors();
          ...
          _this14.saveComponent(component, parent, isNew, original);
        });
      });
