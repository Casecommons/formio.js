...
var ChoicesWrapper = /*#__PURE__*/function (_Choices) {
  ...
  var _proto = ChoicesWrapper.prototype;
  ...
  _proto._onEnterKey = function _onEnterKey(args) {
  ...
  _proto._onTabKey = function _onTabKey(_ref) {
  ...
  _proto._selectHighlightedChoice = function _selectHighlightedChoice(activeItems) {
  ...
  _proto.onSelectValue = function onSelectValue(_ref2) {
  ...
  return _createClass(ChoicesWrapper);
}(_choices["default"]);
