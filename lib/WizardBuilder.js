...
var WizardBuilder = /*#__PURE__*/function (_WebformBuilder) {
  ...
  var _proto = WizardBuilder.prototype;

  _proto.allowDrop = function allowDrop(element) {
  ...
  _proto.removePage = function removePage(pageIndex, componentIndex) {
  ...
  _proto.setPage = function setPage(index) {
    if (index === this.page) {
      return;
    }
  ...
  _proto.getPageConfig = function getPageConfig(index) {
