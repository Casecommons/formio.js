...
var GoogleAddressProvider = /*#__PURE__*/function (_AddressProvider) {
  ...
  var _proto = GoogleAddressProvider.prototype;

  _proto.setAutocompleteOptions = function setAutocompleteOptions() {
  ...
  _proto.beforeMergeOptions = function beforeMergeOptions(options) {
    // providing support of old Google Provider option
    this.convertRegionToAutocompleteOption(options);
  };

  _proto.getLibraryName = function getLibraryName() {
    return 'googleMaps';
  };

  _proto.convertRegionToAutocompleteOption = function convertRegionToAutocompleteOption(options) {
  ...
  _proto.getRequiredAddressProperties = function getRequiredAddressProperties() {
    return ['address_components', 'formatted_address', 'geometry', 'place_id', 'plus_code', 'types'];
  };

  _proto.addRequiredProviderOptions = function addRequiredProviderOptions(options) {
  ...
  _proto.filterPlace = function filterPlace(place) {
    place = place || {};
    var filteredPlace = {};
  ...
  _proto.attachAutocomplete = function attachAutocomplete(elem, index, onSelectAddress) {
    var _this2 = this;
  ...
  _proto.getDisplayValue = function getDisplayValue(address) {
