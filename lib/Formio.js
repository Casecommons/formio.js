...
var Formio = /*#__PURE__*/function () {
  ...
  var _proto = Formio.prototype;

  _proto["delete"] = function _delete(type, opts) {
  ...
  Formio.useSessionToken = function useSessionToken(options) {
  ...
  _proto.index = function index(type, query, opts) {
    var _url = "".concat(type, "Url");
  ...
  _proto.save = function save(type, data, opts) {
    var _id = "".concat(type, "Id");
  ...
  _proto.load = function load(type, query, opts) {
    var _id = "".concat(type, "Id");
  ...
  _proto.loadProject = function loadProject(query, opts) {
    return this.load('project', query, opts);
  };

  _proto.saveProject = function saveProject(data, opts) {
    return this.save('project', data, opts);
  };

  _proto.deleteProject = function deleteProject(opts) {
    return this["delete"]('project', opts);
  };

  Formio.loadProjects = function loadProjects(query, opts) {
    query = query || '';
  ...
  _proto.loadRole = function loadRole(opts) {
    return this.load('role', null, opts);
  };

  _proto.saveRole = function saveRole(data, opts) {
    return this.save('role', data, opts);
  };

  _proto.deleteRole = function deleteRole(opts) {
    return this["delete"]('role', opts);
  };

  _proto.loadRoles = function loadRoles(opts) {
    return this.index('roles', null, opts);
  };

  _proto.loadForm = function loadForm(query, opts) {
    var _this2 = this;
  ...
  _proto.saveForm = function saveForm(data, opts) {
    return this.save('form', data, opts);
  };

  _proto.deleteForm = function deleteForm(opts) {
    return this["delete"]('form', opts);
  };

  _proto.loadForms = function loadForms(query, opts) {
    return this.index('forms', query, opts);
  };

  _proto.loadSubmission = function loadSubmission(query, opts) {
    var _this3 = this;
  ...
  _proto.saveSubmission = function saveSubmission(data, opts) {
  ...
  _proto.deleteSubmission = function deleteSubmission(opts) {
    return this["delete"]('submission', opts);
  };

  _proto.loadSubmissions = function loadSubmissions(query, opts) {
    return this.index('submissions', query, opts);
  };

  _proto.loadAction = function loadAction(query, opts) {
    return this.load('action', query, opts);
  };

  _proto.saveAction = function saveAction(data, opts) {
    return this.save('action', data, opts);
  };

  _proto.deleteAction = function deleteAction(opts) {
    return this["delete"]('action', opts);
  };

  _proto.loadActions = function loadActions(query, opts) {
    return this.index('actions', query, opts);
  };

  _proto.availableActions = function availableActions() {
    return this.makeRequest('availableActions', "".concat(this.formUrl, "/actions"));
  };

  _proto.actionInfo = function actionInfo(name) {
    return this.makeRequest('actionInfo', "".concat(this.formUrl, "/actions/").concat(name));
  };

  _proto.isObjectId = function isObjectId(id) {
    var checkForHexRegExp = new RegExp('^[0-9a-fA-F]{24}$');
    return checkForHexRegExp.test(id);
  };

  _proto.getProjectId = function getProjectId() {
    if (!this.projectId) {
  ...
  _proto.getFormId = function getFormId() {
    if (!this.formId) {
      return _nativePromiseOnly["default"].resolve('');
    }
  ...
  _proto.currentUser = function currentUser(options) {
    return Formio.currentUser(this, options);
  };

  _proto.accessInfo = function accessInfo() {
  ...
  _proto.setToken = function setToken(token, options) {
  ...
  _proto.getTempToken = function getTempToken(expire, allowed, options) {
  ...
  _proto.getDownloadUrl = function getDownloadUrl(form) {
    var _this4 = this;
  ...
  _proto.uploadFile = function uploadFile(storage, file, fileName, dir, progressCallback, url, options, fileKey, groupPermissions, groupId, uploadStartCallback, abortCallback) {
    var _this5 = this;
  ...
  _proto.downloadFile = function downloadFile(file, options) {
    var _this6 = this;
  ...
  _proto.deleteFile = function deleteFile(file, options) {
    var _this7 = this;
  ...
  _proto.userPermissions = function userPermissions(user, form, submission) {
  ...
  _proto.getUrlParts = function getUrlParts(url) {
    return Formio.getUrlParts(url, this);
  };

  Formio.getUrlParts = function getUrlParts(url, formio) {
  ...
  Formio.serialize = function serialize(obj, _interpolate) {
    var str = [];
  ...
  Formio.getRequestArgs = function getRequestArgs(formio, type, url, method, data, opts) {
  ...
  Formio.makeStaticRequest = function makeStaticRequest(url, method, data, opts) {
  ...
  Formio.makeRequest = function makeRequest(formio, type, url, method, data, opts) {
    if (!formio) {
  ...
  Formio.request = function request(url, method, data, header, opts) {
    if (!url) {
  ...
  Formio.setToken = function setToken() {
  ...
  Formio.getToken = function getToken(options) {
  ...
  Formio.setUser = function setUser(user) {
  ...
  Formio.getUser = function getUser(options) {
    options = options || {};
    var userName = "".concat(options.namespace || Formio.namespace || 'formio', "User");
  ...
  Formio.setBaseUrl = function setBaseUrl(url) {
    Formio.baseUrl = url;
  ...
  Formio.getBaseUrl = function getBaseUrl() {
    return Formio.baseUrl;
  };

  Formio.setApiUrl = function setApiUrl(url) {
    return Formio.setBaseUrl(url);
  };

  Formio.getApiUrl = function getApiUrl() {
    return Formio.getBaseUrl();
  };

  Formio.setAppUrl = function setAppUrl(url) {
    console.warn('Formio.setAppUrl() is deprecated. Use Formio.setProjectUrl instead.');
    Formio.projectUrl = url;
    Formio.projectUrlSet = true;
  };

  Formio.setProjectUrl = function setProjectUrl(url) {
    Formio.projectUrl = url;
    Formio.projectUrlSet = true;
  };

  Formio.setAuthUrl = function setAuthUrl(url) {
    Formio.authUrl = url;
  };

  Formio.getAppUrl = function getAppUrl() {
    console.warn('Formio.getAppUrl() is deprecated. Use Formio.getProjectUrl instead.');
    return Formio.projectUrl;
  };

  Formio.getProjectUrl = function getProjectUrl() {
    return Formio.projectUrl;
  };

  Formio.clearCache = function clearCache() {
    Formio.cache = {};
  };

  Formio.noop = function noop() {};

  Formio.identity = function identity(value) {
    return value;
  };

  Formio.deregisterPlugin = function deregisterPlugin(plugin) {
  ...
  Formio.registerPlugin = function registerPlugin(plugin, name) {
    var __Formio = Formio;
  ...
  Formio.getPlugin = function getPlugin(name) {
  ...
  Formio.pluginWait = function pluginWait(pluginFn) {
  ...
  Formio.pluginGet = function pluginGet(pluginFn) {
  ...
  Formio.pluginAlter = function pluginAlter(pluginFn, value) {
  ...
  Formio.accessInfo = function accessInfo(formio) {
  ...
  Formio.projectRoles = function projectRoles(formio) {
    var projectUrl = formio ? formio.projectUrl : Formio.projectUrl;
    return Formio.makeRequest(formio, 'projectRoles', "".concat(projectUrl, "/role"));
  };

  Formio.currentUser = function currentUser(formio, options) {
    var _this9 = this;
  ...
  Formio.logout = function logout(formio, options) {
    options = options || {};
  ...
  Formio.pageQuery = function pageQuery() {
    var pageQuery = {};
    pageQuery.paths = [];
  ...
  Formio.oAuthCurrentUser = function oAuthCurrentUser(formio, token) {
  ...
  Formio.samlInit = function samlInit(options) {
    options = options || {};
  ...
  Formio.oktaInit = function oktaInit(options) {
    options = options || {};
  ...
  Formio.ssoInit = function ssoInit(type, options) {
    switch (type) {
      case 'saml':
  ...
  Formio.requireLibrary = function requireLibrary(name, property, src, polling, onload) {
  ...
  Formio.libraryReady = function libraryReady(name) {
  ...
  Formio.addToGlobal = function addToGlobal(global) {
    if (_typeof(global) === 'object' && !global.Formio) {
      global.Formio = Formio;
    }
  };

  Formio.setPathType = function setPathType(type) {
    if (typeof type === 'string') {
      Formio.pathType = type;
    }
  };

  Formio.getPathType = function getPathType() {
    return Formio.pathType;
  };

  _createClass(Formio, null, [{
    key: "token",
    get: function get() {
      if (!Formio.tokens) {
        Formio.tokens = {};
...
Formio.currentUserResolved = true;
Formio.libraries = {};
