...
var StripeComponent = /*#__PURE__*/function (_Component) {
  ...
  var _proto = StripeComponent.prototype;
  ...
  _proto.authorizePending = function authorizePending() {
  ...
  _proto.authorizeError = function authorizeError(resultError) {
  ...
  _proto.authorizeDone = function authorizeDone(result) {
  ...
  _proto.onElementCardChange = function onElementCardChange(result) {
  ...
  return _createClass(StripeComponent);
}(_Component2["default"]);
