...
var StripeCheckoutComponent = /*#__PURE__*/function (_ButtonComponent) {
  ...
  var _proto = StripeCheckoutComponent.prototype;
  ...
  _proto.onToken = function onToken(token) {
  ...
  _proto.onClickButton = function onClickButton(event) {
    var _this2 = this;
  ...
  _createClass(StripeCheckoutComponent, null, [{
    key: "builderInfo",
    get: function get() {
      return {
        group: false,
