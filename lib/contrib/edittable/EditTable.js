...
var EditTableComponent = /*#__PURE__*/function (_DataGridComponent) {
  ...
  EditTableComponent.schema = function schema() {
  ...
  var _proto = EditTableComponent.prototype;

  _proto.hasColumns = function hasColumns() {
  ...
  _proto.addEmptyRows = function addEmptyRows(n) {
  ...
  _proto.buildRows = function buildRows() {
  ...
  _proto.buildGroups = function buildGroups() {
    var _this3 = this;
  ...
  _proto.getRowChunks = function getRowChunks(groups, coll) {
  ...
  _proto.buildGroup = function buildGroup(_ref3) {
  ...
  _proto.buildRow = function buildRow(row, index) {
    var _this4 = this;
  ...
  _proto.removeButton = function removeButton(index) {
    var _this5 = this;
  ...
  _proto.builderView = function builderView() {
    return this.ce('div', {
