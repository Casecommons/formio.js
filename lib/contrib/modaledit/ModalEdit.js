...
var ModalEditComponent = /*#__PURE__*/function (_TextAreaComponent) {
  ...
  ModalEditComponent.schema = function schema() {
  ...
  var _proto = ModalEditComponent.prototype;
  ...
  _proto.attachElement = function attachElement(element) {
  ...
  _proto.createModal = function createModal(element) {
    var _this = this;
  ...
  _proto.updateOnChange = function updateOnChange(flags) {
  ...
  _proto.updateContentView = function updateContentView() {
    var content = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '';
  ...
  _proto.getElementRect = function getElementRect(elt) {
    return elt.getBoundingClientRect();
  };

  _proto.getModalStyle = function getModalStyle(args) {
  ...
  _proto.getModalLayout = function getModalLayout(rect) {
  ...
  _proto.getModalSize = function getModalSize(currentWidth, currentHeight) {
