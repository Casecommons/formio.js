...
var Webform = /*#__PURE__*/function (_NestedDataComponent) {
  ...
  function Webform() {
    ...
    _this2.executeShortcuts = function (event) {
   ...
   * @return {*}
   */
  _proto.addLanguage = function addLanguage(code, lang) {
  ...
  _proto.localize = function localize() {
    ...
    return new _nativePromiseOnly["default"](function (resolve, reject) {
      try {
        _this3.i18next.init(_objectSpread(_objectSpread({}, _this3.options.i18n), {
  ...
  _proto.keyboardCatchableElement = function keyboardCatchableElement(element) {
   ...
   */
  _proto.loadSubmission = function loadSubmission() {
    var _this4 = this;
  ...
  _proto.setSrc = function setSrc(value, options) {
    var _this5 = this;
   ...
   * @param options
   */
  _proto.setUrl = function setUrl(value, options) {
   ...
   * @returns {*}
   */
  _proto.setForm = function setForm(form, flags) {
   ...
   */
  _proto.setSubmission = function setSubmission(submission) {
    var _this7 = this;
  ...
  _proto.saveDraft = function saveDraft() {
    var _this8 = this;
  ...
  _proto.restoreDraft = function restoreDraft(userId) {
    var _this9 = this;
  ...
  _proto.mergeData = function mergeData(_this, _that) {
  ...
  _proto.setValue = function setValue(submission) {
    var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _proto.executeFormController = function executeFormController() {
    var _this11 = this;
  ...
  _proto.hasRequiredFields = function hasRequiredFields() {
    var result = false;
  ...
  _proto.setAlert = function setAlert(type, message, options) {
    var _this14 = this;
  ...
  _proto.focusOnComponent = function focusOnComponent(key) {
    if (key) {
  ...
  _proto.showErrors = function showErrors(error, triggerEvent, onChange) {
    var _this15 = this;
    ...
    errors.forEach(function (err) {
      ...
      components.forEach(function (path) {
        var originalPath = _this15._parentPath + (0, _utils.getStringFromComponentPath)(path);

        var component = _this15.getComponent(path, _lodash["default"].identity, originalPath);
    ...
    errors.forEach(function (err) {
      if (err) {
        var createListItem = function createListItem(message, index) {
          ...
          formattedKeyOrPath = _this15._parentPath + formattedKeyOrPath;
        ...
        if (err.messages && err.messages.length) {
          ...
          err.messages.forEach(function (_ref, index) {
            ...
            var text = context !== null && context !== void 0 && context.hasLabel || fromServer ? _this15.t('alertMessage', {
              message: _this15.t(message)
          ...
          var message = _lodash["default"].isObject(err) ? _this15.t('alertMessage', {
            message: _this15.t(err.message || '')
          }) : _this15.t('alertMessage', {
            message: _this15.t(err)
          });
  ...
  _proto.onSubmit = function onSubmit(submission, saved) {
  ...
  _proto.normalizeError = function normalizeError(error) {
    if (error) {
  ...
  _proto.onSubmissionError = function onSubmissionError(error) {
  ...
  _proto.onChange = function onChange(flags, changed, modified, changes) {
    flags = flags || {};
  ...
  _proto.checkData = function checkData(data) {
    var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _proto.deleteSubmission = function deleteSubmission() {
    var _this16 = this;
  ...
  _proto.cancel = function cancel(noconfirm) {
  ...
  _proto.setMetadata = function setMetadata(submission) {
  ...
  _proto.submitForm = function submitForm() {
    ...
    return new _nativePromiseOnly["default"](function (resolve, reject) {
      ...
      _this17.hook('beforeSubmit', _objectSpread(_objectSpread({}, submission), {}, {
        ...
        if (!isDraft && !_this17.checkValidity(submission.data, true)) {
          return reject();
        }
        ...
        _this17.hook('customValidation', _objectSpread(_objectSpread({}, submission), {}, {
          ...
          if (_this17._form && _this17._form.action) {
            ...
            return _Formio.GlobalFormio.makeStaticRequest(_this17._form.action, method, submission, _this17.formio ? _this17.formio.options : {}).then(function (result) {
              return resolve({
                submission: result,
                saved: true
              });
            })["catch"](function (error) {
              _this17.setServerErrors(error);
  ...
  _proto.setServerErrors = function setServerErrors(error) {
    if (error.details) {
  ...
  _proto.executeSubmit = function executeSubmit(options) {
    var _this18 = this;
    ...
    return this.submitForm(options).then(function (_ref2) {
      ...
      _this18.submissionInProcess = false;
      return results;
    })["catch"](function (err) {
      _this18.submissionInProcess = false;
  ...
  _proto.clearServerErrors = function clearServerErrors() {
    ...
    (_this$serverErrors = this.serverErrors) === null || _this$serverErrors === void 0 ? void 0 : _this$serverErrors.forEach(function (error) {
      if (error.path) {
        ...
        var component = _this19.getComponent(pathArray, _lodash["default"].identity, error.formattedKeyOrPath);
  ...
  _proto.submit = function submit(before, options) {
    var _this20 = this;
  ...
  _proto.submitUrl = function submitUrl(URL, headers) {
    var _this21 = this;
    ...
    if (API_URL && settings) {
      _Formio.GlobalFormio.makeStaticRequest(API_URL, settings.method, submission, {
        ...
        _this21.showErrors("".concat(e.statusText ? e.statusText : '', " ").concat(e.status ? e.status : e));

        _this21.emit('error', "".concat(e.statusText ? e.statusText : '', " ").concat(e.status ? e.status : e));

        console.error("".concat(e.statusText ? e.statusText : '', " ").concat(e.status ? e.status : e));

        _this21.setAlert('danger', "<p> ".concat(e.statusText ? e.statusText : '', " ").concat(e.status ? e.status : e, " </p>"));
      });
    } else {
  ...
  _proto.triggerRecaptcha = function triggerRecaptcha() {
