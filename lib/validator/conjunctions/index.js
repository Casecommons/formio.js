...
var Conjunctions = /*#__PURE__*/function () {
  ...
  Conjunctions.addConjunction = function addConjunction(name, conjunction) {
    Conjunctions.conjunctions[name] = conjunction;
  };

  Conjunctions.addConjunctions = function addConjunctions(conjunctions) {
    Conjunctions.conjunctions = _objectSpread(_objectSpread({}, Conjunctions.conjunctions), conjunctions);
  };

  Conjunctions.getConjunction = function getConjunction(name) {
    return Conjunctions.conjunctions[name];
  };

  Conjunctions.getConjunctions = function getConjunctions() {
    return Conjunctions.conjunctions;
  };

  return _createClass(Conjunctions);
}();
