...
var ValueSources = /*#__PURE__*/function () {
  ...
  ValueSources.addValueSource = function addValueSource(name, valueSource) {
    ValueSources.valueSources[name] = valueSource;
  };

  ValueSources.addValueSources = function addValueSources(valueSources) {
    ValueSources.valueSources = _objectSpread(_objectSpread({}, ValueSources.valueSources), valueSources);
  };

  ValueSources.getValueSource = function getValueSource(name) {
    return ValueSources.valueSources[name];
  };

  ValueSources.getValueSources = function getValueSources() {
