...
var Transformers = /*#__PURE__*/function () {
  ...
  Transformers.addTransformer = function addTransformer(name, transformer) {
    Transformers.transformers[name] = transformer;
  };

  Transformers.addTransformers = function addTransformers(transformers) {
    Transformers.transformers = _objectSpread(_objectSpread({}, Transformers.transformers), transformers);
  };

  Transformers.getTransformer = function getTransformer(name) {
    return Transformers.transformers[name];
  };

  Transformers.getTransformers = function getTransformers() {
    return Transformers.transformers;
  };

  return _createClass(Transformers);
}();
