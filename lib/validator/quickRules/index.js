...
var QuickRules = /*#__PURE__*/function () {
  ...
  QuickRules.addQuickRule = function addQuickRule(name, quickRule) {
    QuickRules.quickRules[name] = quickRule;
  };

  QuickRules.addQuickRules = function addQuickRules(quickRules) {
    QuickRules.quickRules = _objectSpread(_objectSpread({}, QuickRules.quickRules), quickRules);
  };

  QuickRules.getQuickRule = function getQuickRule(name) {
    return QuickRules.quickRules[name];
  };

  QuickRules.getQuickRules = function getQuickRules() {
    return QuickRules.quickRules;
  };

  return _createClass(QuickRules);
}();
