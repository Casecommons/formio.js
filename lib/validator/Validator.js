...
var ValidationChecker = /*#__PURE__*/function () {
  ...
  var _proto = ValidationChecker.prototype;

  _proto.checkValidator = function checkValidator(component, validator, setting, value, data, index, row, async) {
    var _this2 = this;
  ...
  _proto.validate = function validate(component, validatorName, value, data, index, row, async, conditionallyVisible, validationObj) {
  ...
  _proto.checkComponent = function checkComponent(component, data, row) {
  ...
  _proto.checkValidations = function checkValidations(component, validations, data, row, values, async) {
    var _this4 = this;
  ...
  _proto.checkRule = function checkRule(component, validation, data, row, values, async) {
