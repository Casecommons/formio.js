...
var Rules = /*#__PURE__*/function () {
  ...
  Rules.addRule = function addRule(name, rule) {
    Rules.rules[name] = rule;
  };

  Rules.addRules = function addRules(rules) {
    Rules.rules = _objectSpread(_objectSpread({}, Rules.rules), rules);
  };

  Rules.getRule = function getRule(name) {
    return Rules.rules[name];
  };

  Rules.getRules = function getRules() {
    return Rules.rules;
  };
