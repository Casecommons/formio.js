...
class Component extends Element_1.default {
    ...
    setValueAt(index, value, flags = {}) {
        ...
        if ((valueMaskInput === null || valueMaskInput === void 0 ? void 0 : valueMaskInput.mask) && valueMaskInput.mask.textMaskInputElement && value) {
            valueMaskInput.mask.textMaskInputElement.update(value);
        }
        if (input.mask && input.mask.textMaskInputElement && value) {
    ...
    detachLogic() {
        var _a;
        (_a = this.logic) === null || _a === void 0 ? void 0 : _a.forEach(logic => {
            var _a;
            if (((_a = logic === null || logic === void 0 ? void 0 : logic.trigger) === null || _a === void 0 ? void 0 : _a.type) === 'event') {
