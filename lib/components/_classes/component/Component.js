...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } /* globals Quill, ClassicEditor, CKEDITOR */
 ...
 */
var Component = exports["default"] = /*#__PURE__*/function (_Element) {
  ...
  function Component(component, options, data) {
    ...
    _this.originalComponent = (0, _utils.fastCloneDeep)(_this.component);
     ...
     * @type {boolean}
     */
    _this._disabled = (0, _utils.boolValue)(_this.component.disabled) ? _this.component.disabled : false;
  ...
  _createClass(Component, [{
    ...
    get: function get() {
      ...
      if (this.hasInput && this.component.validate && (0, _utils.boolValue)(this.component.validate.required) && !isPDFReadOnlyMode) {
    ...
    key: "schema",
    get: function get() {
      return (0, _utils.fastCloneDeep)(this.getModifiedSchema(_lodash["default"].omit(this.component, 'id'), this.defaultSchema));
    }
    ...
    value: function checkRefresh(refreshData, changed, flags) {
      ...
      } else if (changePath && (0, _utils.getComponentPath)(changed.instance) === refreshData && changed && changed.instance &&
    ...
    value: function refresh(value) {
      ...
      this.refreshOnValue = (0, _utils.fastCloneDeep)(value);
    ...
    get: function get() {
      ...
      if (this.hasInput && this.component.validate && (0, _utils.boolValue)(this.component.validate.required)) {
        className += ' required';
      }
    ...
    value: function fieldLogic(data, row) {
      ...
      var newComponent = (0, _utils.fastCloneDeep)(this.originalComponent);
    ...
    value: function clearOnHide() {
      ...
      (!this.rootPristine || this.options.server || (0, _utils.isInsideScopingComponent)(this)) && this.component.clearOnHide !== false && !this.options.readOnly && !this.options.showHiddenFields) {
        if (!this.visible) {
          this.deleteValue();
    ...
    value: function detachLogic() {
      var _this$logic,
        _this21 = this;
      (_this$logic = this.logic) === null || _this$logic === void 0 ? void 0 : _this$logic.forEach(function (logic) {
        var _logic$trigger;
        if ((logic === null || logic === void 0 ? void 0 : (_logic$trigger = logic.trigger) === null || _logic$trigger === void 0 ? void 0 : _logic$trigger.type) === 'event') {
    ...
    value: function attachLogic() {
      ...
      (_this$logic2 = this.logic) === null || _this$logic2 === void 0 ? void 0 : _this$logic2.forEach(function (logic) {
        if (logic.trigger.type === 'event') {
          var event = _this22.interpolate(logic.trigger.event);
          _this22.on(event, function () {
            var newComponent = (0, _utils.fastCloneDeep)(_this22.originalComponent);
            ...
            if (_this22.applyActions(newComponent, logic.actions, args)) {
              ...
              if (!_lodash["default"].isEqual(_this22.component, newComponent)) {
                ...
                var disabled = _this22.shouldDisabled;
