...
var Component = /*#__PURE__*/function (_Element) {
  ...
  Component.schema = function schema() {
  ...
  Component.tableView = function tableView(value, options) {}
  ...
  _proto.mergeSchema = function mergeSchema() {
  ...
  _proto.createAddon = function createAddon(addonConfiguration) {
  ...
  _proto.rightDirection = function rightDirection(direction) {
    return direction === 'right';
  };

  _proto.getLabelInfo = function getLabelInfo() {
  ...
  _proto.getModifiedSchema = function getModifiedSchema(schema, defaultSchema, recursion) {
    var _this4 = this;
  ...
  _proto.labelIsHidden = function labelIsHidden() {
  ...
  _proto.getTemplate = function getTemplate(names, modes) {
  ...
  _proto.checkTemplate = function checkTemplate(templates, names, modes) {
  ...
  _proto.checkTemplateMode = function checkTemplateMode(templatesByName, modes) {
  ...
  _proto.getFormattedTooltip = function getFormattedTooltip(tooltipValue) {
  ...
  _proto.isHtmlRenderMode = function isHtmlRenderMode() {
    return this.options.renderMode === 'html';
  };

  _proto.renderTemplate = function renderTemplate(name) {
    var _this5 = this;
  ...
  _proto.sanitize = function sanitize(dirty, forceSanitize, options) {
    var _this$options;
  ...
  _proto.renderString = function renderString(template, data) {
    if (!template) {
      return '';
  ...
  _proto.performInputMapping = function performInputMapping(input) {
    return input;
  };

  _proto.getBrowserLanguage = function getBrowserLanguage() {
  ...
  _proto.beforePage = function beforePage() {
    return _nativePromiseOnly["default"].resolve(true);
  };

  _proto.beforeNext = function beforeNext() {
  ...
  _proto.loadRefs = function loadRefs(element, refs) {
    for (var ref in refs) {
  ...
  _proto.setOpenModalElement = function setOpenModalElement(template) {
    this.componentModal.setOpenModalElement(template || this.getModalPreviewTemplate());
  };

  _proto.getModalPreviewTemplate = function getModalPreviewTemplate() {
  ...
  _proto.attachTooltips = function attachTooltips(toolTipsRefs) {
    var _this6 = this;
  ...
  _proto.createComponentModal = function createComponentModal(element, modalShouldBeOpened, currentValue) {
  ...
  _proto.addShortcut = function addShortcut(element, shortcut) {
  ...
  _proto.removeShortcut = function removeShortcut(element, shortcut) {
    // Avoid infinite recursion.
  ...
  _proto.checkRefresh = function checkRefresh(refreshData, changed, flags) {
  ...
  _proto.checkRefreshOn = function checkRefreshOn(changes) {
    var _this7 = this;
  ...
  _proto.refresh = function refresh(value) {
  ...
  _proto.inContext = function inContext(component) {
  ...
  _proto.createViewOnlyElement = function createViewOnlyElement() {
   ...
   * @return {*}
   */
  _proto.getWidgetValueAsString = function getWidgetValueAsString(value, options) {
    var _this8 = this;
  ...
  _proto.getValueAsString = function getValueAsString(value, options) {
    if (!value) {
      return '';
    }
  ...
  _proto.getView = function getView(value, options) {
  ...
  _proto.itemValue = function itemValue(data) {
  ...
  _proto.itemValueForHTMLMode = function itemValueForHTMLMode(value) {
    var _this9 = this;
  ...
  _proto.createModal = function createModal(element, attr, confirm) {
    var _this10 = this;
  ...
  _proto.evalContext = function evalContext(additional) {
  ...
  _proto.iconClass = function iconClass(name, spinning) {
  ...
  _proto.size = function size(_size) {
   ...
   * @return {*}
   */
  _proto.errorMessage = function errorMessage(type) {
    return this.component.errors && this.component.errors[type] ? this.component.errors[type] : type;
  };

  _proto.setContent = function setContent(element, content, forceSanitize, sanitizeOptions) {
  ...
  _proto.restoreCaretPosition = function restoreCaretPosition() {
    var _this$root2;
  ...
  _proto.hasClass = function hasClass(element, className) {
    if (!element) {
      return;
    }
  ...
  _proto.conditionallyVisible = function conditionallyVisible(data, row) {
  ...
  _proto.checkCondition = function checkCondition(row, data) {
  ...
  _proto.checkComponentConditions = function checkComponentConditions(data, flags, row) {
    data = data || this.rootValue;
    flags = flags || {};
    row = row || this.data;
   ...
   * @param data
   */
  _proto.fieldLogic = function fieldLogic(data, row) {
    var _this11 = this;
  ...
  _proto.defineActionValue = function defineActionValue(action, argsObject) {
    return this.evaluate(action.value, argsObject, 'value');
  };

  _proto.applyActions = function applyActions(newComponent, actions, result, row, data) {
    var _this12 = this;
  ...
  _proto.addInputError = function addInputError(message, dirty, elements) {
    this.addMessages(message);
    this.setErrorClasses(elements, dirty, !!message);
  } // Deprecated
  ;

  _proto.removeInputError = function removeInputError(elements) {
  ...
  _proto.addMessages = function addMessages(messages) {
    var _this13 = this;
  ...
  _proto.setElementInvalid = function setElementInvalid(element, invalid) {
    if (!element) return;
  ...
  _proto.clearOnHide = function clearOnHide() {
  ...
  _proto.triggerRootChange = function triggerRootChange() {
  ...
  _proto.onChange = function onChange(flags, fromRoot) {
    flags = flags || {};
  ...
  _proto.addCKE = function addCKE(element, settings, onChange) {
  ...
  _proto.addQuill = function addQuill(element, settings, onChange) {
    var _this15 = this;
  ...
  _proto.addAce = function addAce(element, settings, onChange) {
   ...
   *
   */
  _proto.hasValue = function hasValue(data) {
   ...
   * @param index
   */
  _proto.splice = function splice(index) {
    var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _proto.getCustomDefaultValue = function getCustomDefaultValue(defaultValue) {
  ...
  _proto.getValueAt = function getValueAt(index) {
  ...
  _proto.setValueAt = function setValueAt(index, value) {
  ...
  _proto.updateComponentValue = function updateComponentValue(value) {
    var flags = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  ...
  _proto.getIcon = function getIcon(name, content, styles) {
  ...
  _proto.hasChanged = function hasChanged(newValue, oldValue) {
  ...
  _proto.updateOnChange = function updateOnChange() {
  ...
  _proto.convertNumberOrBoolToString = function convertNumberOrBoolToString(value) {
  ...
  _proto.doValueCalculation = function doValueCalculation(dataValue, data, row) {
  ...
  _proto.calculateComponentValue = function calculateComponentValue(data, flags, row) {
  ...
  _proto.invalidMessage = function invalidMessage(data, dirty, ignoreCondition, row) {
  ...
  _proto.setComponentValidity = function setComponentValidity(messages, dirty, silentCheck) {
  ...
  _proto.checkComponentValidity = function checkComponentValidity(data, dirty, row) {
  ...
  _proto.checkData = function checkData(data, flags, row) {
    data = data || this.rootValue;
    flags = flags || {};
  ...
  _proto.checkModal = function checkModal() {
  ...
  _proto.isEqual = function isEqual(valueA) {
  ...
  _proto.validateMultiple = function validateMultiple() {
    return true;
  };

  _proto.clearErrorClasses = function clearErrorClasses() {
  ...
  _proto.setInputWidgetErrorClasses = function setInputWidgetErrorClasses(inputRefs, hasErrors) {
  ...
  _proto.setCustomValidity = function setCustomValidity(messages, dirty, external) {
    var _this17 = this;
    ...
    if (this.component.multiple) {
      ...
      inputRefsArray.forEach(function (input) {
        _this17.setElementInvalid(_this17.performInputMapping(input), false);
      });
  ...
  _proto.isValueHidden = function isValueHidden() {
  ...
  _proto.shouldSkipValidation = function shouldSkipValidation(data, dirty, row) {
    ...
    function () {
      return _this18.component.validate.custom && !_this18.dataValue && !_this18.component.validate.required;
    }, // Force valid if component is read-only
    function () {
      return _this18.options.readOnly;
    }, // Do not check validations if component is not an input component.
    function () {
      return !_this18.hasInput;
    }, // Check to see if we are editing and if so, check component persistence.
    function () {
      return _this18.isValueHidden();
    }, // Force valid if component is hidden.
    function () {
      return !_this18.visible;
    }, // Force valid if component is conditionally hidden.
    function () {
      return !_this18.checkCondition(row, data);
    }];
   ...
   */
  _proto.asString = function asString(value) {
  ...
  _proto.setDisabled = function setDisabled(element, disabled) {
    if (!element) {
      return;
    }
  ...
  _proto.setLoading = function setLoading(element, loading) {
  ...
  _proto.selectOptions = function selectOptions(select, tag, options, defaultValue) {
    var _this19 = this;
  ...
  _proto.setSelectValue = function setSelectValue(select, value) {
  ...
  _proto.getRelativePath = function getRelativePath(path) {
  ...
  _proto.append = function append(element) {
    this.appendTo(element, this.element);
  };

  _proto.prepend = function prepend(element) {
  ...
  _proto.detachLogic = function detachLogic() {
    var _this20 = this;
    ...
    this.logic.forEach(function (logic) {
      if (logic.trigger.type === 'event') {
        ...
        _this20.off(event); // only applies to callbacks on this component

      }
    });
  };

  _proto.attachLogic = function attachLogic() {
    var _this21 = this;
    ...
    this.logic.forEach(function (logic) {
      if (logic.trigger.type === 'event') {
        ...
        _this21.on(event, function () {
          var newComponent = (0, FormioUtils.fastCloneDeep)(_this21.originalComponent);

          for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
            args[_key5] = arguments[_key5];
          }

          if (_this21.applyActions(newComponent, logic.actions, args)) {
            // If component definition changed, replace it.
            if (!_lodash["default"].isEqual(_this21.component, newComponent)) {
              _this21.component = newComponent;

              var visible = _this21.conditionallyVisible(null, null);

              var disabled = _this21.shouldDisabled; // Change states which won't be recalculated during redrawing

              if (_this21.visible !== visible) {
                _this21.visible = visible;
              }

              if (_this21.disabled !== disabled) {
                _this21.disabled = disabled;
              }
  ...
  _proto.elementInfo = function elementInfo() {
    var attributes = {
  ...
  _proto.resetCaches = function resetCaches() {};
  ...
  _createClass(Component, [{
    ...
    get: function get() {
      ...
      if (settings && (_this$root4 = this.root) !== null && _this$root4 !== void 0 && _this$root4.shadowRoot) {
    ...
    get: function get() {
      ...
      var checkMask = function checkMask(value) {
        if (typeof value === 'string') {
          var placeholderChar = _this23.placeholderChar;
          value = (0, _vanillaTextMask.conformToMask)(value, _this23.defaultMask, {
            placeholderChar: placeholderChar
          }).conformedValue;

          if (!FormioUtils.matchInputMask(value, _this23.defaultMask)) {
            value = '';
          }
        } else {
          value = '';
