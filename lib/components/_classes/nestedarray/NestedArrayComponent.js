...
var NestedArrayComponent = /*#__PURE__*/function (_NestedDataComponent) {
  ...
  NestedArrayComponent.schema = function schema() {
  ...
  var _proto = NestedArrayComponent.prototype;
  ...
  _proto.checkAddButtonChanged = function checkAddButtonChanged() {
  ...
  _proto.checkRows = function checkRows(method, data, opts, defaultValue, silentCheck) {
    var _this = this;
  ...
  _proto.checkRow = function checkRow(method, data, opts, row, components, silentCheck) {
  ...
  _proto.everyComponent = function everyComponent(fn, rowIndex, options) {
    var _options;
