...
var Input = /*#__PURE__*/function (_Multivalue) {
  ...
  _proto.getMaskByName = function getMaskByName(maskName) {
  ...
  _proto.setInputMask = function setInputMask(input, inputMask) {
  ...
  _proto.getMaskOptions = function getMaskOptions() {
  ...
  _proto.getWordCount = function getWordCount(value) {
  ...
  _proto.setCounter = function setCounter(type, element, count, max) {
    if (max) {
  ...
  _proto.updateValueAt = function updateValueAt(value, flags, index) {
    flags = flags || {};
  ...
  _proto.updateValue = function updateValue(value, flags, index) {
    flags = flags || {};
  ...
  _proto.getWidget = function getWidget(index) {
    index = index || 0;
  ...
  _proto.createWidget = function createWidget(index) {
    var _this$root,
        _this3 = this;
  ...
  _proto.addFocusBlurEvents = function addFocusBlurEvents(element) {
    var _this4 = this;
