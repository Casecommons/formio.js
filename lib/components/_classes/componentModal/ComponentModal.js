...
var ComponentModal = /*#__PURE__*/function () {
  ComponentModal.render = function render(component, data, topLevel) {
  ...
  var _proto = ComponentModal.prototype;
  ...
  _proto.loadRefs = function loadRefs() {
  ...
  _proto.setEventListeners = function setEventListeners() {
  ...
  _proto.isValueChanged = function isValueChanged() {
  ...
  _proto.setOpenEventListener = function setOpenEventListener() {
  ...
  _proto.openModalHandler = function openModalHandler(event) {
    event.preventDefault();
    this.openModal();
  };

  _proto.positionOverElement = function positionOverElement() {
  ...
  _proto.closeModalHandler = function closeModalHandler(event) {
    event.preventDefault();
  ...
  _proto.closeDialog = function closeDialog(event) {
    event.preventDefault();
    this.dialog.close();
  ...
  _proto.saveDialog = function saveDialog(event) {
    this.closeDialog(event);
    this.closeModalHandler(event);
  };

  _proto.saveModalValueHandler = function saveModalValueHandler(event) {
