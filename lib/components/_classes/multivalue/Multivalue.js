...
var Multivalue = /*#__PURE__*/function (_Field) {
  ...
  _proto.useWrapper = function useWrapper() {
  ...
  _proto.attach = function attach(dom) {
    var _this = this;
  ...
  _proto.saveCaretPosition = function saveCaretPosition(element, index) {
  ...
  _proto.onSelectMaskHandler = function onSelectMaskHandler(event) {
    this.updateMask(event.target.maskInput, this.getMaskPattern(event.target.value));
  };

  _proto.getMaskPattern = function getMaskPattern(maskName) {
    if (!this.multiMasks) {
      this.multiMasks = {};
    }
  ...
  _proto.attachMultiMask = function attachMultiMask(index) {
  ...
  _proto.updateMask = function updateMask(input, mask) {
    if (!mask) {
      return;
    }
  ...
  _proto.addNewValue = function addNewValue(value) {
    if (value === undefined) {
