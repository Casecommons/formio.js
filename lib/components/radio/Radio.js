...
var RadioComponent = /*#__PURE__*/function (_Field) {
  ...
  RadioComponent.schema = function schema() {
  ...
  var _proto = RadioComponent.prototype;
  ...
  _proto.detach = function detach(element) {
    var _this3 = this;
  ...
  _proto.setSelectedClasses = function setSelectedClasses() {
    var _this5 = this;
  ...
  _proto.updateValue = function updateValue(value, flags) {
