...
var Alert = /*#__PURE__*/function () {
  ...
  _proto.showErrors = function showErrors() {
  ...
  _proto.showMessage = function showMessage(message, type) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  _proto.createMessagesList = function createMessagesList(type) {
    switch (type) {
      case 'error':
  ...
  _proto.createErrorList = function createErrorList(errors) {
    var _this = this;
  ...
  _proto.showAlert = function showAlert(type, messagesList) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  _proto.setAlert = function setAlert(type, messagesList) {
    var options = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
  ...
  _proto.attach = function attach(options) {
  ...
  _proto.focusOnComponent = function focusOnComponent(keyOrPath) {
    if (keyOrPath) {
  ...
  _proto.createMessage = function createMessage(type, element, message, index, err) {
    switch (type) {
      case 'error':
  ...
  _proto.createErrorMessage = function createErrorMessage(element, message, index, err) {
  ...
  _proto.appendErrorToList = function appendErrorToList(err, ul) {
    var _err$messages2,
        _this4 = this;
