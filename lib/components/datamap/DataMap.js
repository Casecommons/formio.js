...
var DataMapComponent = /*#__PURE__*/function (_DataGridComponent) {
  ...
  DataMapComponent.schema = function schema() {
  ...
  var _proto = DataMapComponent.prototype;
  ...
  _proto.componentContext = function componentContext(component) {
  ...
  _proto.getRowKey = function getRowKey(rowIndex) {
  ...
  _proto.getDataValueAsTable = function getDataValueAsTable(value, options) {
    var _this3 = this;
  ...
  _proto.addChildComponent = function addChildComponent(component) {
    this.component.valueComponent = component;
  };

  _proto.saveChildComponent = function saveChildComponent(component) {
  ...
  _proto.removeChildComponent = function removeChildComponent() {
  ...
  _proto.checkColumns = function checkColumns() {
    return {
      rebuild: false,
      show: true
    };
