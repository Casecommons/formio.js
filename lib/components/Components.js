...
var Components = /*#__PURE__*/function () {
  ...
  Components.recalculateComponents = function recalculateComponents() {
    if (window && window.Formio && window.Formio.AllComponents) {
      Components.setComponents(window.Formio.AllComponents);
    }
  };

  Components.setComponents = function setComponents(comps) {
  ...
  Components.addComponent = function addComponent(name, comp) {
    return Components.setComponent(name, comp);
  };

  Components.setComponent = function setComponent(name, comp) {
    Components.components[name] = comp;
  };

  Components.create = function create(component, options, data) {
    var comp = null;
...
Components._editFormUtils = _utils["default"];
Components._baseEditForm = _Component2["default"];