...
var ReCaptchaComponent = /*#__PURE__*/function (_Component) {
  ...
  ReCaptchaComponent.schema = function schema() {
  ...
  var _proto = ReCaptchaComponent.prototype;
  ...
  _proto.createLabel = function createLabel() {
    return;
  };

  _proto.verify = function verify(actionName) {
    var _this = this;
  ...
  _proto.sendVerificationRequest = function sendVerificationRequest(token) {
  ...
  _proto.normalizeValue = function normalizeValue(newValue) {
  ...
  _createClass(ReCaptchaComponent, null, [{
    key: "builderInfo",
    get: function get() {
      return {
        title: 'reCAPTCHA',
