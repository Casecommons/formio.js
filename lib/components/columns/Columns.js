...
var ColumnsComponent = /*#__PURE__*/function (_NestedComponent) {
  ...
  ColumnsComponent.schema = function schema() {
  ...
  var _proto = ColumnsComponent.prototype;
  ...
  _proto.justifyColumn = function justifyColumn(items, index) {
  ...
  _proto.justify = function justify() {
    var _this4 = this;

    return this.columns.reduce(function (redraw, items, index) {
      return _this4.justifyColumn(items, index) || redraw;
    }, false);
  };
   ...
   */
  _proto.groupByRow = function groupByRow() {
    var _this6 = this;
    ...
    get: function get() {
      ...
      (_schema$columns = schema.columns) === null || _schema$columns === void 0 ? void 0 : _schema$columns.map(function (column, colIndex) {
        column.components.map(function (comp, compIndex) {
          ...
          var component = _this7.createComponent(clonedComp);
