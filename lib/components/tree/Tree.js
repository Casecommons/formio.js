...
var TreeComponent = /*#__PURE__*/function (_NestedDataComponent) {
  ...
  TreeComponent.schema = function schema() {
  ...
  _proto.createComponents = function createComponents(data, node) {
    var _this2 = this;
  ...
  _proto.removeComponents = function removeComponents(components) {
  ...
  _proto.attachNode = function attachNode(element, node) {
    if (!element) {
  ...
  _proto.attachActions = function attachActions(node) {
  ...
  _proto.attachComponents = function attachComponents(node) {
    if (this.builderMode) {
      var _get2;
  ...
  _proto.attachChildren = function attachChildren(node) {
    var _this5 = this;
  ...
  _proto.addChild = function addChild(parent) {
    var _this6 = this;
  ...
  _proto.cancelNode = function cancelNode(node) {
    var _this7 = this;
  ...
  _proto.editNode = function editNode(node) {
    var _this8 = this;
  ...
  _proto.revertNode = function revertNode(node) {
    var _this10 = this;
  ...
  _proto.saveNode = function saveNode(node) {
    var _this11 = this;
  ...
  _proto.toggleNode = function toggleNode(node) {
    var _this12 = this;
  ...
  _proto.removeRoot = function removeRoot() {
    if (this.options.readOnly) {
      return;
    }
  ...
  _proto.setRoot = function setRoot() {
  ...
  _proto.checkNode = function checkNode(data, node, flags, row) {
    var _this13 = this;
