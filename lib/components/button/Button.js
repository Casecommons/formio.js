...
var ButtonComponent = /*#__PURE__*/function (_Field) {
  ...
  ButtonComponent.schema = function schema() {
  ...
  _proto.createInput = function createInput(container) {
  ...
  _proto.attachButton = function attachButton() {
    var _this2 = this;
  ...
  _proto.openOauth = function openOauth(settings) {
    var _this3 = this;
