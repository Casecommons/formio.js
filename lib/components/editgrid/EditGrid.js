...
var EditGridComponent = /*#__PURE__*/function (_NestedArrayComponent) {
  ...
  EditGridComponent.schema = function schema() {
  ...
  var _proto = EditGridComponent.prototype;

  _proto.hasRemoveButtons = function hasRemoveButtons() {
  ...
  _proto.isOpen = function isOpen(editRow) {
    return [EditRowState.New, EditRowState.Editing, EditRowState.Viewing].includes(editRow.state);
  };

  _proto.isComponentVisibleInSomeRow = function isComponentVisibleInSomeRow(component) {
    var _this3 = this;
  ...
  _proto.flattenRowDataValue = function flattenRowDataValue(dataValue) {
    var _this6 = this;
  ...
  _proto.isComponentVisibleInRow = function isComponentVisibleInRow(component, flattenedComponents) {
    var instance = flattenedComponents[component.key];
    return instance ? instance.visible : true;
  };

  _proto.displayComponentValue = function displayComponentValue(component, header) {
  ...
  _proto.renderRow = function renderRow(row, rowIndex) {
    var _this7 = this;
  ...
  _proto.eachComponent = function eachComponent(fn, rowIndex) {
  ...
  _proto.flattenComponents = function flattenComponents(rowIndex) {
    var result = {};
  ...
  _proto.getComponents = function getComponents(rowIndex) {
  ...
  _proto.destroyComponents = function destroyComponents(rowIndex) {
    var _this9 = this;
  ...
  _proto.createRow = function createRow(dataObj, rowIndex) {
    var editRow = {
  ...
  _proto.addRowModal = function addRowModal(rowIndex) {
    var _this10 = this;
  ...
  _proto.showDialog = function showDialog(rowIndex) {
    var editRow = this.editRows[rowIndex];
  ...
  _proto.clearErrors = function clearErrors(rowIndex) {
    var editRow = this.editRows[rowIndex];
  ...
  _proto.cancelRow = function cancelRow(rowIndex) {
    if (this.options.readOnly) {
      return;
    }
  ...
  _proto.saveRow = function saveRow(rowIndex, modified) {
    var _this11 = this;
  ...
  _proto.updateComponentsRowIndex = function updateComponentsRowIndex(components, rowIndex) {
  ...
  _proto.updateRowsComponents = function updateRowsComponents(rowIndex) {
    var _this12 = this;
  ...
  _proto.baseRemoveRow = function baseRemoveRow(rowIndex) {
    var editRow = this.editRows[rowIndex];
    editRow.state = EditRowState.Removed;
    this.destroyComponents(rowIndex);
    return editRow;
  ...
  _proto.removeRow = function removeRow(rowIndex, modified) {
    if (this.options.readOnly) {
      return;
    }
  ...
  _proto.createRowComponents = function createRowComponents(row, rowIndex) {
    var _this13 = this;
  ...
  _proto.hasOpenRows = function hasOpenRows() {
    var _this14 = this;
  ...
  _proto.shouldValidateDraft = function shouldValidateDraft(editRow) {
  ...
  _proto.shouldValidateRow = function shouldValidateRow(editRow, dirty) {
    return this.shouldValidateDraft(editRow) || editRow.state === EditRowState.Editing || editRow.alerts || dirty;
  };

  _proto.validateRow = function validateRow(editRow, dirty, forceSilentCheck) {
    var _this15 = this,
        _this$root3;
  ...
  _proto.showRowErrorAlerts = function showRowErrorAlerts(editRow, valid) {
    if (editRow.alerts) {
      if (this.alert) {
        var _editRow$errors;
  ...
  _proto.changeState = function changeState(changed, flags) {
  ...
  _proto.openWhenEmpty = function openWhenEmpty() {
  ...
  _proto.restoreRowContext = function restoreRowContext(editRow) {
    var _this18 = this;
  ...
  _proto.emptyRows = function emptyRows() {
    var _this19 = this;
