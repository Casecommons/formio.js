...
var SignatureComponent = /*#__PURE__*/function (_Input) {
  ...
  SignatureComponent.schema = function schema() {
  ...
  var _proto = SignatureComponent.prototype;
  ...
  _proto.showCanvas = function showCanvas(show) {
    if (show) {
      if (this.refs.canvas) {
  ...
  _proto.checkSize = function checkSize(force, scale) {
  ...
  _proto.setDataToSigaturePad = function setDataToSigaturePad() {
    this.signaturePad.fromDataURL(this.dataValue, {
      ratio: 1,
