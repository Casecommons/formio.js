...
var TextAreaComponent = /*#__PURE__*/function (_TextFieldComponent) {
  ...
  TextAreaComponent.schema = function schema() {
  ...
  var _proto = TextAreaComponent.prototype;
  ...
  _proto.renderElement = function renderElement(value, index) {
   ...
   * @param newValue
   */
  _proto.updateEditorValue = function updateEditorValue(index, newValue) {
  ...
  _proto.attachElement = function attachElement(element, index) {
    var _this2 = this;
  ...
  _proto.imageHandler = function imageHandler(moduleInstance, range, files) {
    var _this3 = this;
  ...
  _proto.setContent = function setContent(element, content, forceSanitize) {
  ...
  _proto.setReadOnlyValue = function setReadOnlyValue(value, index) {
    index = index || 0;
  ...
  _proto.setConvertedValue = function setConvertedValue(value, index) {
  ...
  _proto.setAsyncConvertedValue = function setAsyncConvertedValue(value) {
  ...
  _proto.setImagesUrl = function setImagesUrl(images) {
    var _this6 = this;
  ...
  _proto.addAutoExpanding = function addAutoExpanding(textarea, index) {
  ...
  _proto.trimBlanks = function trimBlanks(value) {
  ...
  _proto.getConvertedValue = function getConvertedValue(value) {
    if (this.isJsonValue && value) {
      try {
