...
var SelectComponent = /*#__PURE__*/function (_Field) {
  ...
  SelectComponent.schema = function schema() {
  ...
  var _proto = SelectComponent.prototype;
  ...
  _proto.isEntireObjectDisplay = function isEntireObjectDisplay() {
    return this.component.dataSrc === 'resource' && this.valueProperty === 'data';
  };

  _proto.getSelectTemplate = function getSelectTemplate(data, value) {
  ...
  _proto.selectValueAndLabel = function selectValueAndLabel(data) {
  ...
  _proto.itemTemplate = function itemTemplate(data, value) {
  ...
  _proto.addOption = function addOption(value, label) {
  ...
  _proto.addValueOptions = function addValueOptions(items) {
    items = items || [];
    var added = false;
  ...
  _proto.disableInfiniteScroll = function disableInfiniteScroll() {
  ...
  _proto.setItems = function setItems(items, fromSearch) {
    var _this2 = this,
        _this$choices,
        _this$choices$input;
  ...
  _proto.getSingleItemValueForHTMLMode = function getSingleItemValueForHTMLMode(data) {
  ...
  _proto.getTemplateKeys = function getTemplateKeys() {
    var _this4 = this;
  ...
  _proto.loadItems = function loadItems(url, search, headers, options, method, body) {
    var _this5 = this;
  ...
  _proto.handleLoadingError = function handleLoadingError(err) {
    this.loading = false;
  ...
  _proto.getCustomItems = function getCustomItems() {
  ...
  _proto.asyncCustomValues = function asyncCustomValues() {
  ...
  _proto.updateCustomItems = function updateCustomItems(forceUpdate) {
    var _this6 = this;
  ...
  _proto.refresh = function refresh(value, _ref3) {
  ...
  /* eslint-disable max-statements */
  _proto.updateItems = function updateItems(searchInput, forceUpdate) {
    var _this7 = this;
  ...
  _proto.addPlaceholder = function addPlaceholder() {
  ...
  _proto.setLoadingItem = function setLoadingItem() {
  ...
  _proto.wrapElement = function wrapElement(element) {
    return this.component.addResource && !this.options.readOnly ? this.renderTemplate('resourceAdd', {
      element: element
    }) : element;
  };

  _proto.choicesOptions = function choicesOptions() {
  ...
  _proto.attachRefreshOnBlur = function attachRefreshOnBlur() {
    var _this9 = this;
  ...
  _proto.addPlaceholderItem = function addPlaceholderItem(placeholderValue) {
   ...
   * @param {Array} items
   */
  _proto.addCurrentChoices = function addCurrentChoices(values, items, keyValue) {
    var _this10 = this;
  ...
  _proto.getValueAsString = function getValueAsString(data) {
  ...
  _proto.normalizeSingleValue = function normalizeSingleValue(value, retainObject) {
    var _this$root;
  ...
  _proto.normalizeValue = function normalizeValue(value) {
    ...
    if (this.component.multiple && Array.isArray(value)) {
      return value.map(function (singleValue) {
        return _this11.normalizeSingleValue(singleValue, true);
      });
    }
  ...
  _proto.isInitApiCallNeeded = function isInitApiCallNeeded(hasValue) {
  ...
  _proto.setChoicesValue = function setChoicesValue(value, hasPreviousValue) {
  ...
  _proto.validateValueAvailability = function validateValueAvailability(setting, value) {
    var _this13 = this;
    ...
    if (values) {
      if (_lodash["default"].isObject(value)) {
        var compareComplexValues = function compareComplexValues(optionValue) {
          var normalizedOptionValue = _this13.normalizeSingleValue(optionValue, true);
  ...
  _proto.getOptionValue = function getOptionValue(value) {
  ...
  _proto.getOptionsValues = function getOptionsValues() {
    var _this14 = this;
  ...
  _proto.isBooleanOrNumber = function isBooleanOrNumber(value) {
    return typeof value === 'number' || typeof value === 'boolean';
  };

  _proto.getNormalizedValues = function getNormalizedValues() {
    var _this15 = this;
  ...
  _proto.setErrorClasses = function setErrorClasses(elements, dirty, hasError, hasMessages) {
      ...
      if (this.component.data && this.component.data.headers) {
        try {
          _lodash["default"].each(this.component.data.headers, function (header) {
            if (header.key) {
              headers.set(header.key, _this17.interpolate(header.value));
            }
          });
        } catch (err) {
          console.warn(err.message);
