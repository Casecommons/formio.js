...
var FileComponent = /*#__PURE__*/function (_Field) {
  ...
  FileComponent.schema = function schema() {
  ...
  var _proto = FileComponent.prototype;
  ...
  _proto.loadImage = function loadImage(fileInfo) {
  ...
  _proto.getVideoStream = function getVideoStream(constraints) {
  ...
  _proto.stopVideoStream = function stopVideoStream(videoStream) {
    videoStream.getVideoTracks().forEach(function (track) {
      return track.stop();
    });
  };

  _proto.getFrame = function getFrame(videoPlayer) {
  ...
  _proto.takePicture = function takePicture() {
    var _this3 = this;
  ...
  _proto.browseFiles = function browseFiles() {
    var _this4 = this;
  ...
  _proto.deleteFile = function deleteFile(fileInfo) {
  ...
  _proto.fileSize = function fileSize(a, b, c, d, e) {
  ...
  _proto.globStringToRegex = function globStringToRegex(str) {
    str = str.replace(/\s/g, '');
    var regexp = '',
        excludes = [];
  ...
  _proto.translateScalars = function translateScalars(str) {
  ...
  _proto.validatePattern = function validatePattern(file, val) {
    if (!val) {
      return true;
    }
  ...
  _proto.validateMinSize = function validateMinSize(file, val) {
    return file.size + 0.1 >= this.translateScalars(val);
  };

  _proto.validateMaxSize = function validateMaxSize(file, val) {
    return file.size - 0.1 <= this.translateScalars(val);
  };
  ...
  _proto.getFile = function getFile(fileInfo) {
