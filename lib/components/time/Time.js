...
var TimeComponent = /*#__PURE__*/function (_TextFieldComponent) {
  ...
  TimeComponent.schema = function schema() {
  ...
  var _proto = TimeComponent.prototype;
  ...
  _proto.isNotCompleteInput = function isNotCompleteInput(value) {
  ...
  _proto.resetRawData = function resetRawData(index) {
    if (index) {
  ...
  _proto.setRawValue = function setRawValue(value, index) {
  ...
  _proto.getRawValue = function getRawValue(index) {
  ...
  _proto.getStringAsValue = function getStringAsValue(view) {
  ...
  _proto.getInputMaskFromFormat = function getInputMaskFromFormat(format) {
    if (format === 'LT') {
      return '99:99 AA';
    }
