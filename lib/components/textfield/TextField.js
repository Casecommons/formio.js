...
var TextFieldComponent = /*#__PURE__*/function (_Input) {
  ...
  TextFieldComponent.schema = function schema() {
  ...
  var _proto = TextFieldComponent.prototype;
  ...
  _proto.maskValue = function maskValue(value) {
  ...
  _proto.unmaskValue = function unmaskValue(value) {
  ...
  _proto.truncateMultipleSpaces = function truncateMultipleSpaces(value) {
    if (value) {
