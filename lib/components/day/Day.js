...
var DayComponent = /*#__PURE__*/function (_Field) {
  ...
  DayComponent.schema = function schema() {
  ...
  var _proto = DayComponent.prototype;

  _proto.inputDefinition = function inputDefinition(name) {
    var min, max;
  ...
  _proto.selectDefinition = function selectDefinition(name) {
    return {
      multiple: false,
      ref: name,
      widget: 'html5',
  ...
  _proto.setErrorClasses = function setErrorClasses(elements, dirty, hasError) {
  ...
  _proto.validateRequired = function validateRequired(setting, value) {
   ...
   * @return {*}
   */
  _proto.getDate = function getDate(value) {
    var defaults = [],
        day,
        month,
  ...
  _proto.normalizeMinMaxDates = function normalizeMinMaxDates() {
  ...
  _proto.isPartialDay = function isPartialDay(value) {
    if (!value) {
      return false;
    }
  ...
  _proto.getValidationFormat = function getValidationFormat() {
