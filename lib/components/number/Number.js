...
var NumberComponent = /*#__PURE__*/function (_Input) {
  ...
  NumberComponent.schema = function schema() {
  ...
  var _proto = NumberComponent.prototype;

  _proto.createNumberMask = function createNumberMask() {
  ...
  _proto.setInputMask = function setInputMask(input) {
  ...
  _proto.parseValue = function parseValue(input) {
  ...
  _proto.getMaskedValue = function getMaskedValue(value) {
