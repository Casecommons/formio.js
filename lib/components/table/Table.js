...
var TableComponent = /*#__PURE__*/function (_NestedComponent) {
  ...
  TableComponent.emptyTable = function emptyTable(numRows, numCols) {
    var rows = [];
  ...
  TableComponent.schema = function schema() {
  ...
  _proto.init = function init() {
    ...
    _lodash["default"].each(this.component.rows, function (row, rowIndex) {
      _this2.table[rowIndex] = [];

      _lodash["default"].each(row, function (column, colIndex) {
        _this2.table[rowIndex][colIndex] = [];

        if (_this2.component.cloneRows) {
          if (column.components.length) {
            ...
            _builder["default"].uniquify(_this2.root._form.components, column);
          }
        }
        ...
        _lodash["default"].each(column.components, function (comp) {
          ...
          var component = _this2.createComponent(columnComponent);

          component.tableRow = rowIndex;
          component.tableColumn = colIndex;

          _this2.table[rowIndex][colIndex].push(component);
        });
      });
    });
  };
  ...
  _proto.attach = function attach(element) {
    ...
    var keys = this.table.reduce(function (prev, row, rowIndex) {
      prev["".concat(_this4.tableKey, "-").concat(rowIndex)] = 'multiple';
      return prev;
    }, {});
    ...
    this.table.forEach(function (row, rowIndex) {
      row.forEach(function (column, columnIndex) {
        _this4.attachComponents(_this4.refs["".concat(_this4.tableKey, "-").concat(rowIndex)][columnIndex], _this4.table[rowIndex][columnIndex], _this4.component.rows[rowIndex][columnIndex].components);
      });
    });
    return superAttach;
  };

  _proto.destroy = function destroy(all) {
