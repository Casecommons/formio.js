...
var SelectBoxesComponent = /*#__PURE__*/function (_RadioComponent) {
  ...
  SelectBoxesComponent.schema = function schema() {
  ...
  var _proto = SelectBoxesComponent.prototype;
  ...
  _proto.setInputsDisabled = function setInputsDisabled(value, onlyUnchecked) {
    if (this.refs.input) {
  ...
  _proto.checkComponentValidity = function checkComponentValidity(data, dirty, rowData, options) {
    var _this3 = this;
