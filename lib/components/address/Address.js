...
var AddressComponent = /*#__PURE__*/function (_ContainerComponent) {
  ...
  AddressComponent.schema = function schema() {
  ...
  var _proto = AddressComponent.prototype;
  ...
  _proto.initializeProvider = function initializeProvider(provider) {
  ...
  _proto.isValueInLegacyFormat = function isValueInLegacyFormat(value) {
  ...
  _proto.renderElement = function renderElement(value) {
  ...
  _proto.renderRow = function renderRow(value, index) {
  ...
  _proto.onSelectAddress = function onSelectAddress(address, element, index) {
    if (this.isMultiple) {
  ...
  _proto.clearAddress = function clearAddress(element, index) {
    var _this$address;
  ...
  _proto.updateRemoveIcon = function updateRemoveIcon(index) {
