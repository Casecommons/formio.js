...
var DataGridComponent = /*#__PURE__*/function (_NestedArrayComponent) {
  ...
  DataGridComponent.schema = function schema() {
   ...
   * @return {Array<T[]>}
   */
  _proto.getRowChunks = function getRowChunks(groups, rows) {
  ...
  _proto.hasTopSubmit = function hasTopSubmit() {
    return this.hasAddButton() && ['top', 'both'].includes(this.addAnotherPosition);
  };

  _proto.hasBottomSubmit = function hasBottomSubmit() {
  ...
  _proto.hasHeader = function hasHeader() {
  ...
  _proto.attach = function attach(element) {
    ...
    this.rows.forEach(function (row, rowIndex) {
      ...
      columns.forEach(function (col) {
        _this3.attachComponents(_this3.refs[_this3.datagridKey][rowIndex * rowLength + columnIndex], [_this3.rows[rowIndex][col.key]], _this3.getComponentsContainer());
  ...
  _proto.getComponentsContainer = function getComponentsContainer() {
    return this.component.components;
  };

  _proto.onReorder = function onReorder(element, _target, _source, sibling) {
  ...
  _proto.focusOnNewRowElement = function focusOnNewRowElement(row) {
  ...
  _proto.addRow = function addRow() {
    ...
    this.redraw().then(function () {
      _this4.focusOnNewRowElement(_this4.rows[index]);
    });
  };
  ...
  _proto.removeRowComponents = function removeRowComponents(row) {
    var _this7 = this;
  ...
  _proto.getRowValues = function getRowValues() {
    return this.dataValue;
  };

  _proto.setRowComponentsData = function setRowComponentsData(rowIndex, rowData) {
    _lodash["default"].each(this.rows[rowIndex], function (component) {
      component.data = rowData;
    });
  };

  _proto.createRows = function createRows(init, rebuild) {
    var _this8 = this;
  ...
  _proto.checkColumns = function checkColumns(data) {
    var _this10 = this;
      ...
      _lodash["default"].each(row, function (col, key) {
        if (col && typeof col.checkConditions === 'function') {
          ...
          if (col.component.logic && firstRowCheck) {
            var compIndex = _lodash["default"].findIndex(_this10.columns, ['key', key]);

            if (!_lodash["default"].isEqual(_this10.columns[compIndex], col.component)) {
              logicRebuild = true;
              _this10.columns[compIndex] = col.component;
            }
          }
        }
      });
  ...
  _proto.getComponent = function getComponent(path, fn) {
  ...
  _proto.toggleGroup = function toggleGroup(element, index) {
