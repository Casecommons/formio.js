...
var FormComponent = /*#__PURE__*/function (_Component) {
  ...
  FormComponent.schema = function schema() {
  ...
  _proto.setFormRevision = function setFormRevision(rev) {
  ...
  _proto.getSubOptions = function getSubOptions() {
  ...
  _proto.getValueAsString = function getValueAsString(value) {
    if (!value) {
  ...
  _proto.everyComponent = function everyComponent() {
    if (this.subForm) {
      var _this$subForm;
  ...
  _proto.setSubFormDisabled = function setSubFormDisabled(subForm) {
    subForm.disabled = this.disabled; // When the Nested Form is disabled make the subForm disabled
  };

  _proto.updateSubWizards = function updateSubWizards(subForm) {
    var _this$root,
        _subForm$_form,
        _this2 = this;
    ...
    if (this.isNestedWizard && (_this$root = this.root) !== null && _this$root !== void 0 && _this$root.subWizards && (subForm === null || subForm === void 0 ? void 0 : (_subForm$_form = subForm._form) === null || _subForm$_form === void 0 ? void 0 : _subForm$_form.display) === 'wizard') {
      var existedForm = this.root.subWizards.findIndex(function (form) {
        return form.component.form === _this2.component.form;
      });
  ...
  _proto.createSubForm = function createSubForm(fromAttach) {
    var _this3 = this;
    ...
    this.subFormReady = this.loadSubForm(fromAttach).then(function (form) {
      ...
      return new _Form["default"](form, _this3.getSubOptions()).ready.then(function (instance) {
        ...
        _this3.subForm.localRoot = _this3.isNestedWizard ? _this3.localRoot : _this3.subForm;
      ...
      _this3.updateSubWizards(subForm);
  ...
  _proto.hideSubmitButton = function hideSubmitButton(component) {
  ...
  _proto.loadSubForm = function loadSubForm(fromAttach) {
    var _this4 = this;
  ...
  _proto.checkComponentValidity = function checkComponentValidity(data, dirty, row, options) {
    options = options || {};
  ...
  _proto.checkComponentConditions = function checkComponentConditions(data, flags, row) {
    ...
    // so we need to perform checkConditions after it is ready, or some conditional fields might be hidden in View mode
      ...
      this.subFormReady.then(function () {
        if (_this5.subForm) {
          return _this5.subForm.checkConditions(_this5.subFormData);
        }
      });
    }
   ...
   * @return {*}
   */
  _proto.getSubFormData = function getSubFormData() {
  ...
  _proto.submitSubForm = function submitSubForm(rejectOnError) {
    var _this6 = this;
  ...
  _proto.isSubFormLazyLoad = function isSubFormLazyLoad() {
  ...
  _proto.setSubFormValue = function setSubFormValue(submission, flags) {
  ...
  _proto.areAllComponentsEmpty = function areAllComponentsEmpty(data) {
    var res = true;
  ...
  _proto.updateSubFormVisibility = function updateSubFormVisibility() {
    if (this.subForm) {
  ...
  _proto.isInternalEvent = function isInternalEvent(event) {
    switch (event) {
      case 'focus':
      case 'blur':
  ...
  _proto.createEmitter = function createEmitter() {
