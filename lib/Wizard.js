...
var Wizard = /*#__PURE__*/function (_Webform) {
  ...
  _proto.prepareNavigationSettings = function prepareNavigationSettings(ctx) {
  ...
  _proto.prepareHeaderSettings = function prepareHeaderSettings(ctx, headerType) {
    ...
    if (this.component.key) {
      ctx.panels.map(function (panel) {
        if (panel.key === _this4.component.key) {
          ...
          ctx.wizardPageTooltip = _this4.getFormattedTooltip(panel.tooltip);
        }
      });
    }
  ...
  _proto.redrawNavigation = function redrawNavigation() {
    if (this.element) {
  ...
  _proto.redrawHeader = function redrawHeader() {
    if (this.element) {
  ...
  _proto.attach = function attach(element) {
    ...
    return promises.then(function () {
      ...
      if (_this5.component.scrollToTop) {
        _this5.scrollPageToTop();
      }
    });
  };

  _proto.scrollPageToTop = function scrollPageToTop() {
    var _this$refs$;
  ...
  _proto.isBreadcrumbClickable = function isBreadcrumbClickable() {
    var _this6 = this;
  ...
  _proto.isAllowPrevious = function isAllowPrevious() {
    var _this7 = this;
  ...
  _proto.handleNaviageteOnEnter = function handleNaviageteOnEnter(event) {
    if (event.keyCode === 13) {
  ...
  _proto.handleSaveOnEnter = function handleSaveOnEnter(event) {
    if (event.keyCode === 13) {
      var clickEvent = new CustomEvent('click');
  ...
  _proto.attachNav = function attachNav() {
    var _this8 = this;
  ...
  _proto.emitWizardPageSelected = function emitWizardPageSelected(index) {
    this.emit('wizardPageSelected', this.pages[index], index);
  };

  _proto.attachHeader = function attachHeader() {
    var _this9 = this;
  ...
  _proto.detachNav = function detachNav() {
    var _this10 = this;
  ...
  _proto.detachHeader = function detachHeader() {
    var _this11 = this;
  ...
  _proto.transformPages = function transformPages() {
    var _this12 = this;
  ...
  _proto.getSortedComponents = function getSortedComponents(_ref) {
  ...
  _proto.findRootPanel = function findRootPanel(component) {
  ...
  _proto.setRootPanelId = function setRootPanelId(component) {
  ...
  _proto.establishPages = function establishPages() {
    var _this13 = this;
    ...
    if (this.originalComponents) {
      this.originalComponents.forEach(function (item) {
        if (item.type === 'panel') {
          ...
          var forceShow = _this13.options.show ? _this13.options.show[item.key] : false;
          var forceHide = _this13.options.hide ? _this13.options.hide[item.key] : false;
          var isVisible = !page ? (0, _utils.checkCondition)(item, data, data, _this13.component, _this13) && !item.hidden : page.visible;
  ...
  _proto.updatePages = function updatePages() {
  ...
  _proto.setPage = function setPage(num) {
    var _this14 = this;
      ...
      if (this.hasExtraPages) {
        ...
        if (!pageFromComponents || (pageFromPages === null || pageFromPages === void 0 ? void 0 : pageFromPages.id) !== pageFromComponents.id) {
          parentNum = this.components.findIndex(function (comp) {
            var _this14$pages, _this14$pages$parentN;

            return comp.id === ((_this14$pages = _this14.pages) === null || _this14$pages === void 0 ? void 0 : (_this14$pages$parentN = _this14$pages[parentNum]) === null || _this14$pages$parentN === void 0 ? void 0 : _this14$pages$parentN.rootPanelId);
          });
        }
      }
  ...
  _proto.pageFieldLogic = function pageFieldLogic(page) {
    var _this$pages3;
  ...
  _proto.emitNextPage = function emitNextPage() {
    this.emit('nextPage', {
      page: this.page,
  ...
  _proto.emitPrevPage = function emitPrevPage() {
    this.emit('prevPage', {
      page: this.page,
      submission: this.submission
    });
  ...
  _proto.setComponentSchema = function setComponentSchema() {
    var _this19 = this;
    ...
    this.component.components.map(function (item) {
      if (item.type === 'panel') {
        ...
        if (_this19.wizard.full) {
          _this19.options.show = _this19.options.show || {};
          _this19.options.show[item.key] = true;
        } else if (_this19.wizard.hasOwnProperty('full') && !_lodash["default"].isEqual(_this19.originalOptions.show, _this19.options.show)) {
          _this19.options.show = _objectSpread({}, _this19.originalOptions.show || {});
        }
      }
  ...
  _proto.onSetForm = function onSetForm(clonedForm, initialForm) {
    this.component.components = (this._parentPath ? initialForm.components : clonedForm.components) || [];
    this.setComponentSchema();
  };

  _proto.setEditMode = function setEditMode(submission) {
  ...
  _proto.isClickable = function isClickable(page, index) {
  ...
  _proto.hasButton = function hasButton(name) {
  ...
  _proto.pageId = function pageId(page) {
    if (page.key) {
  ...
  _proto.checkValidity = function checkValidity(data, dirty, row, currentPageOnly) {
