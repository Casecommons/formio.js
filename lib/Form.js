...
var Form = /*#__PURE__*/function (_Element) {
  ...
  function Form() {
    ...
    if (options.useSessionToken) {
      _Formio.GlobalFormio.useSessionToken(options);
    }
  ...
  _proto.create = function create(display) {
  ...
  _proto.errorForm = function errorForm(err) {
    return {
      components: [{
        'label': 'HTML',
        'tag': 'div',
  ...
  _proto.setForm = function setForm(formParam) {
    var _this2 = this;
  ...
  _proto.getSubmission = function getSubmission(formio) {
  ...
  Form.embed = function embed(_embed) {
    var _this3 = this;
    ...
    return new _nativePromiseOnly["default"](function (resolve) {
      ...
      var id = _this3.id || "formio-".concat(Math.random().toString(36).substring(7));
  ...
  _proto.sanitize = function sanitize(dirty, forceSanitize) {
  ...
  _proto.build = function build() {
    ...
    return this.render().then(function (html) {
      _this4.setContent(_this4.element, html);

      return _this4.attach(_this4.element).then(function () {
        return _this4.instance;
      });
    }).then(function (param) {
      _this4.emit('build', param);
