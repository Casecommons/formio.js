...
var Element = /*#__PURE__*/function () {
  ...
  _proto.on = function on(event, cb, internal) {
  ...
  _proto.once = function once(event, cb, internal) {
  ...
  _proto.onAny = function onAny(cb) {
    if (!this.events) {
      return;
    }
  ...
  _proto.offAny = function offAny(cb) {
    if (!this.events) {
      return;
    }
  ...
  _proto.hasEventHandler = function hasEventHandler(event) {
    var _this2 = this;
  ...
  _proto.addEventListener = function addEventListener(obj, type, func, persistent) {
    if (!obj) {
      return;
    }
  ...
  _proto.removeEventListener = function removeEventListener(obj, type) {
    var _this3 = this;
  ...
  _proto.removeAllEvents = function removeAllEvents(includeExternal) {
    var _this5 = this;
  ...
  _proto.appendTo = function appendTo(element, container) {
  ...
  _proto.prependTo = function prependTo(element, container) {
    if (container) {
  ...
  _proto.removeChildFrom = function removeChildFrom(element, container) {
  ...
  _proto.ce = function ce(type, attr) {
  ...
  _proto.appendChild = function appendChild(element, child) {
    var _this6 = this;
  ...
  _proto.maskPlaceholder = function maskPlaceholder(mask) {
    var _this7 = this;
   ...
   */
  _proto.setInputMask = function setInputMask(input, inputMask, usePlaceholder) {
    if (input && inputMask) {
  ...
  _proto.attr = function attr(element, _attr) {
    var _this8 = this;
  ...
  _proto.empty = function empty(element) {
    if (element) {
  ...
  _proto.interpolate = function interpolate(string, data) {
    var _this9 = this;
  ...
  _proto.evaluate = function evaluate(func, args, ret, tokenize) {
